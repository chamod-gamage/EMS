...
public class ViewEmployeeFrame extends javax.swing.JFrame {
     ...
     */
    private javax.swing.table.DefaultTableModel mainModel; // Model for display table
    
    public ViewEmployeeFrame(EmployeeInfo employeeInput) { // Constructor, takes input of employee to view
        initComponents();
        initModel(); // Sets model
        if (employeeInput instanceof PartTimeEmployee) { // Case of PartTimeEmployee, fill table
            setRows(12);
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new java.awt.Font("Garamond", 1, 18)); // NOI18N
    ...
    private void initModel() { // Creates model, code taken from autogenerated code
    ...
    private void setRows(int num) { // Sets number of rows in the model and updates table
